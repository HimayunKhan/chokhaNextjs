...
const Search = () => {
  ...
  return (
    <>
      <div className="flex  h-10  md:inline-flex w-[40%] items-center justify-between relative">
        <input
        ...
        {/* ========== Searchfield ========== */}
        {searchQuery && (
          <div className="  absolute z-100 left-0 top-12 w-full mx-auto max-h-96 bg-color1 rounded-lg overflow-y-scroll cursor-pointer text-black">
